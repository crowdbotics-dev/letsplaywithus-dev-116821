...
## Project Structure
    ...
    ├── letsplaywithus_dev_116821  # Django project configurations
...
1. Clone this repo and `cd letsplaywithus_dev_116821`
...
2. Clone this repo and `cd letsplaywithus_dev_116821`
